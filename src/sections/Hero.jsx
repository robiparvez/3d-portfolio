...
const Hero = () => {
    // Duplicate words for seamless animation loop
            ...
            <div className='hero-layout'>
                ...
                <header className='flex flex-col justify-center md:w-full w-screen md:px-20 px-5'>
                    <div className='flex flex-col gap-7'>
                        ...
                        <p className='text-white-50 md:text-xl relative z-10 pointer-events-none'>Hi, I’m Parvez, a developer based in Dhaka with a passion for code.</p>
